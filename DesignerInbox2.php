...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Employer Inbox | Design Master </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Messages Sent by Designers</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="scroll-vertical" class="table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM messages_designer_to_employer where employeremail='$emaillog' and status='notread'";
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="selernn<?php echo $value4['id']; ?>"><?php echo $value4['designername']; ?></td>
                                                <input type="hidden" id="seleremm<?php echo $value4['id']; ?>" value="<?php echo $value4['designeremail']; ?>"/>
                                                
                                                <td><?php echo $value4['subjectz']; ?></td>
        ...
        <script>
                                ...
                                function SendMessage() {
                                    ...
                                    if (asdasd == "" || subzads == "") {
                                        ...
                                        $.post("phpfiles/designermessagetoemployee2.php",
                                                {
                                        ...
                                        function(data, status) {
                                            if (data == "ok") {
                                                ...
                                                window.location = "DesignerInbox2.php";
                                        ...
                                        dangerMode: true,
                                            ...
                                            .then(function(willDelete) {
                                                if (willDelete) {
                                                    ...
                                                    $.post("Phpfiles/buyermarkmessageasread2.php",
                                                            {
                                                                rowz: dd
