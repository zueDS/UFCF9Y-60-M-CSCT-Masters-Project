...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Designer Inbox | Design Master </title>
    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Messages Sent by Clients</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="scroll-vertical" class="table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM messages_employer_to_designer where designeremail='$emaillog' and statuz='notread'";
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="selernn<?php echo $value4['id']; ?>"><?php echo $value4['employername']; ?></td>
                                                <input type="hidden" id="seleremm<?php echo $value4['id']; ?>" value="<?php echo $value4['employeremail']; ?>"/>
                                                <td><?php echo $value4['reffidz']; ?></td>
                                                <td><?php echo $value4['subject']; ?></td>
                                                <td><?php echo $value4['messagez']; ?></td>
                                                <td><?php echo $value4['datez']; ?></td>
                                                <td><?php echo $value4['timez']; ?></td>

                                                <td><button class="btn btn-success" onclick="messagemarkasreadbuyer(<?php echo $value4['id']; ?>)">Mark As Read</button></td>
                                                <td><button class="btn btn-info" onclick="buyerrmeszz(<?php echo $value4['id']; ?>)">Reply</button></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header p-3 bg-light">
                        <h5 class="modal-title" id="composemodalTitle">Send Reply</h5>
                    ...
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" placeholder="Subject" id="c1" disabled="">
                            </div>
                            <div class="mb-3">
                                <label>Employer Name:</label>
                                <input type="text" class="form-control" placeholder="Subject" id="c2" disabled="">
                            </div>
                            <div class="mb-3">
                                <label>Subject:</label>
                                <input type="text" class="form-control" placeholder="Subject" id="c3">
                            </div>
                            <div class="ck-editor-reverse">
                                <label>Message :</label>
                                <textarea rows="5" id="divms" class="form-control"></textarea>
                            </div>
        ...
        <script>
                                function buyerrmeszz(dd) {
                                    ...
                                    var buyeremailz = $('#seleremm' + dd).val();
                                    var buyerenamez = $('#selernn' + dd).text();

                                    document.getElementById("c1").value = buyeremailz;
                                    document.getElementById("c2").value = buyerenamez;
                                ...
                                function SendMessage() {
                                    ...
                                    var asdasd = $('textarea#divms').val();
                                    var emoployermail = $('#c1').val();
                                    var employername = $('#c2').val();
                                    var subzads = $('#c3').val();
                                    if (asdasd == "" || subzads == "") {
                                        ...
                                        $.post("phpfiles/designermessagetoemployee.php",
                                                {
                                                    emoployermail: emoployermail,
                                        ...
                                        function(data, status) {
                                            if (data == "ok") {
                                                ...
                                                swal("Done!Message Sent to Client..!", {
                                                    icon: "success",
                                                });

                                                window.location = "DesignerInbox.php";
