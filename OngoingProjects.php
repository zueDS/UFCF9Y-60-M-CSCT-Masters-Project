...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Designer ongoing projects | Design Master </title>
    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Ongoing projects</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Currently working projects</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="scroll-vertical" class="table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM newprojectz where designeremaizl='$emaillog' and statusz='Accepted'";
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-success" onclick="acceptproz(<?php echo $value4['id']; ?>)">Complete project</button></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
        ...
        <script>
            ...
            function acceptproz(dd) {

                swal({
                    title: "Are you sure?",
                    text: "You want to Complete this project?",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                        .then(function(willDelete) {
                            if (willDelete) {
                                ...
                                $.post("Phpfiles/designercompletepro.php",
                                        {
                                            rowz: dd
