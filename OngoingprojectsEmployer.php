...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Employer ongoing projects | Design Master </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Accepted projects by designer</h5>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-danger" onclick="acceptproz(<?php echo $value4['id']; ?>)">Cancel project</button></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
