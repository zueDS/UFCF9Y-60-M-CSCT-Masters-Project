...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Project payments | Design Master </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Project payments</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Payments by you</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="scroll-vertical" class="table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM projectpayment where empemailz='$emaillog'";
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $value4['protitle']; ?></td>
                                                        <td><?php echo $value4['designername']; ?></td>
                                                        <td><?php echo $value4['paydatez']; ?></td>
                                                        <td><?php echo $value4['paytimr']; ?></td>
                                                        <td>LKR <?php echo $value4['paymentz']; ?></td>
                    ...
                    dangerMode: true,
                        ...
                        .then(function(willDelete) {
                            if (willDelete) {
                                ...
                                $.post("Phpfiles/cancelprojectemployer.php",
                                        {
                                            rowz: dd
                                ...
                                function(data, status) {
                                    if (data == "ok") {
                                        ...
                                        swal("Done!Project Cancelled..!", {
                                            icon: "success",
                                        });

                                        window.location = "OngoingprojectsEmployer.php";
