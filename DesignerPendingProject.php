...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Designer pending projects | Design Master </title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Pending projects</h4>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Projects assigned by Clients</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="scroll-vertical" class="table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM newprojectz where designeremaizl='$emaillog' and statusz='Pending'";
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $value4['employername']; ?></td>
                                                        <td><?php echo $value4['datez']; ?></td>
                                                        <td><?php echo $value4['timez']; ?></td>
                                                        <td><?php echo $value4['deadlienrz']; ?></td>
                                                        <td>LKR <?php echo $value4['cost']; ?></td>

                                                        <td><button class="btn btn-success" onclick="acceptpro(<?php echo $value4['id']; ?>)">Accept</button></td>
                                                        <td><button class="btn btn-danger" onclick="decpro(<?php echo $value4['id']; ?>)">Decline</button></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
                    ...
                    dangerMode: true,
                        ...
                        .then(function(willDelete) {
                            if (willDelete) {
                                ...
                                $.post("Phpfiles/designeracceptpro.php",
                                        {
                                            rowz: dd
