...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="position-relative mx-n4 mt-n4">
                                <div class="profile-wid-bg profile-setting-img">
                                    <img src="CustomImages/programmer.png" class="profile-wid-img" alt="">
                                        ...
                                        <div class="card-body p-4">
                                            <div class="text-center">
                                                <div class="profile-user position-relative d-inline-block mx-auto  mb-4">
                                                    <img src="CustomImages/programmer.png" class="rounded-circle avatar-xl img-thumbnail user-profile-image" alt="user-profile-image">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3 d-flex">
                                                ...
                                                <input type="email" class="form-control" id="gitUsername" placeholder="Type your skill">
                                            </div>
                                            <div class="mb-3 d-flex">
                                                <div class="avatar-xs d-block flex-shrink-0 me-3">

                                                </div>
                                                <button type="button" class="btn btn-success" onclick="addprofileskillz()">Add Skill</button>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="mb-3 pb-2">
                                                                    ...
                                                                    <textarea class="form-control" id="ff3" placeholder="Enter your description" rows="3"><?php echo $value4['skills']; ?></textarea>
                                                                </div>
                                                            </div>
                                                            <!--end col-->
                                                            <div class="col-lg-12">
    ...
    <script>
            ...
            function updateprofilez() {
                ...
                var namez = $('#ff1').val();
                var contzt = $('#ff2').val();
                var textz = $('textarea#ff3').val();
                
                if (namez == "" || contzt == ""|| textz == "") {
                    swal("Error!", "please fill all feilds..!", "error");

                } else {

                    $.post("phpfiles/Updatedesignerprofile.php",
                            {
                                namez: namez,
                                contzt: contzt,
                                textz: textz
                    ...
                    function(data, status) {
                        if (data == "ok") {
                            ...
                            window.location = "EditprofiledeSigner.php";
    ...
    <script>
            ...
            function addprofileskillz() {

                var namez = $('#gitUsername').val();
                ...
                if (namez == "" ) {
                    ...
                    $.post("phpfiles/addnewskilldesigner.php",
                            {
                                skillnamez: namez
                            },
                    function(data, status) {
                        if (data == "ok") {
                            ...
                            swal("Error!", "Skill Already Exists", "error");
                        } else {
