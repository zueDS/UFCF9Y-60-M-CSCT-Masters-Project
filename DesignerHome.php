                                        ...
                                        <div class="col-xl-12">
                                            <div class="card">
                                                <div class="card-header align-items-center d-flex">
                                                    <h4 class="card-title mb-0 flex-grow-1">Recently received pending projects by clients</h4>
                                                ...
                                                foreach ($query4 as $value4) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class="badge badge-soft-warning p-2" style="font-size: 15px;">Pending</span></td>
