                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Messages Sent by Clients read by you</h5>
                                    </div>
                                    <div class="card-body">
                                        <table id="scroll-vertical" class="table table-bordered dt-responsive nowrap align-middle mdl-data-table" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                $sqlzy34 = "SELECT * FROM messages_employer_to_designer where designeremail='$emaillog' and statuz='read'";
                                    ...
                                    if (asdasd == "" || subzads == "") {
                                        ...
                                        function(data, status) {
                                            if (data == "ok") {
                                                ...
                                                window.location = "SentMessagesbyDesigner.php";
