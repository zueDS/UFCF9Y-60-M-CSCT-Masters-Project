                                ...
                                <div class="card" id="customerList">
                                    <div class="card-header border-bottom-dashed">
                                        ...
                                        <div class="row g-4 align-items-center">
                                            <div class="col-sm">
                                                <div>
                                                    <h5 class="card-title mb-0">Removed Designer List</h5>
                                                </div>
                                            </div>
...
<!--                                                    <button class="btn btn-soft-danger" id="remove-actions" onClick="deleteMultiple()"><i class="ri-delete-bin-2-line"></i></button>
                                            ...
                                            <div class="table-responsive table-card mb-1">
                                                <table class="table align-middle" id="customerTable">
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        ...
                                                        $sqlzy34 = "SELECT * FROM user_details where usertype='Designer' and userstatus='Removed'";
                                                        ...
                                                        <td class="email"><?php echo $value4['email']; ?></td>
                                                        <td class="email"><?php echo $value4['contactnumber']; ?></td>
                                                        <td class="email"><?php echo $value4['addressz']; ?></td>
                                                        <td class="phone"><?php echo $value4['skills']; ?></td>
                                                        <td class="status"><span class="badge badge-soft-danger text-uppercase">Removed</span>
                                                        </td>
    ...
    <script>
            function LoadModelz(dd) {
                swal({
                        title: "Are you sure?",
                        text: "You want to Remove this Designer?",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
                            .then(function(willDelete) {
                                if (willDelete) {
                                    ...
                                    $.post("phpfiles/Removeddesigner.php",
                                            {
                                                dd: dd
                                            },
                                            function(data, status) {
                                                if (data == "ok") {
                                                    ...
                                                    swal("Done!Designer Removed..!", {
                                                        icon: "success",
                                                    });

                                                    window.location = "Alldesigners.php";
