    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sadghg" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-pencil-ruler-2-line"></i>  <span data-key="t-apps">Designers</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sadghg">
                        <ul class="nav nav-sm flex-column">

                            <li class="nav-item">
                                <a href="Alldesigners.php" class="nav-link" data-key="t-calendar">All Designers</a>
                            </li>
                            <li class="nav-item">
                                <a href="RemovedDesiners.php" class="nav-link" data-key="t-calendar">Removed Designers</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sadghg" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-pencil-ruler-2-line"></i>  <span data-key="t-apps">Employers</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sadghg">
                        <ul class="nav nav-sm flex-column">

                            <li class="nav-item">
                                <a href="AllEmployers.php" class="nav-link" data-key="t-calendar">All Employers</a>
                            </li>
                            <li class="nav-item">
                                <a href="Removedemployers.php" class="nav-link" data-key="t-calendar">Removed Employers</a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="AdminActiveGigs.php" class="nav-link" data-key="t-chat"> Active gigs </a>
                            </li>
                            <li class="nav-item">
                                <a href="RemovedGigsadmin.php" class="nav-link" data-key="t-chat"> Removed Gigs </a>
                            </li>
                            <li class="nav-item">
                                <a href="GigHistoryAdmin.php" class="nav-link" data-key="t-chat"> Gig History </a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps222444">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="PendingProjectsAdmin.php" class="nav-link" data-key="t-calendar"> Pending Projects</a>
                            </li>
                            <li class="nav-item">
                                <a href="OngoingAdmin.php" class="nav-link" data-key="t-chat"> Ongoing Projects</a>
                            </li>
                            <li class="nav-item">
                                <a href="WaitingAdmin.php" class="nav-link" data-key="t-chat">Waiting payments</a>
                            </li>
                            <li class="nav-item">
                                <a href="ReceivedpaymentsAdmin.php" class="nav-link" data-key="t-chat">Received payments</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps222" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-pencil-ruler-2-line"></i>  <span data-key="t-apps">Reviews</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarApps222">
                        <ul class="nav nav-sm flex-column">

                            <li class="nav-item">
                                <a href="AdminReviews.php" class="nav-link" data-key="t-calendar">View Reviews</a>
                            </li>
                            <li class="nav-item">
                                <a href="RemovedReviews.php" class="nav-link" data-key="t-calendar">Removed Reviews</a>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarApps222aa" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-pencil-ruler-2-line"></i>  <span data-key="t-apps">Chat bot</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarApps222aa">
                        <ul class="nav nav-sm flex-column">

                            <li class="nav-item">
                                <a href="Trainchatbot.php" class="nav-link" data-key="t-calendar">Train Chat bot</a>
                            </li>
                            <li class="nav-item">
                                <a href="ChatobotCommands.php" class="nav-link" data-key="t-calendar">Commands</a>
                            </li>
