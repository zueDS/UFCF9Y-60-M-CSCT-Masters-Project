...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Assign new project</title>
...
<!--                                                    <button class="btn btn-soft-danger" id="remove-actions" onClick="deleteMultiple()"><i class="ri-delete-bin-2-line"></i></button>
                                                ...
                                                <table class="table align-middle" id="customerTable">
                                                    <thead class="table-light text-muted">
                                                        <tr>
                                                            ...
                                                            <th class="sort" data-sort="phone">Designer Level</th>
                                                            <th class="sort" data-sort="customer_name">Designer</th>
                                                            <th class="sort" data-sort="email">Address</th>                                                    
                                                            <th class="sort" data-sort="date">Skills</th>
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        ...
                                                        foreach ($query4 as $value4) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                if ($ratpointz > 300) {
                                                                    ?>
                                                                    <td><?php echo "Top rated designer"; ?></td><?php
                                                                } else {
                                                                    ?>
                                                                    <td><?php echo "Normal designer"; ?></td><?php }
                                                        ?>
                                                        <input type="hidden" id="seleremmz<?php echo $value4['id_user']; ?>" value="<?php echo $value4['email']; ?>"/>
                                                        <td class="customer_name" id="selernnz<?php echo $value4['id_user']; ?>"><?php echo $value4['nameinfull']; ?></td>
                                                        <td class="email"><?php echo $value4['addressz']; ?></td>
                                                        <td class="phone"><?php echo $value4['skills']; ?></td>
                                                        ...
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="ASsign Project">
                                                                    <button type="button" class="btn btn-success add-btn" onclick="LoadModelz(<?php echo $value4['id_user']; ?>)"><i class="ri-add-line align-bottom me-1"></i> Assign Project</button>
                                                    ...
                                                    <div class="tablelist-form">
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="hstack gap-2 justify-content-end">
                                                                ...
                                                                <button type="button" class="btn btn-success" onclick="AssignProjectz()">Assign project</button>
    ...
    <script>
            function LoadModelz(dd) {
                ...
                var designeremail = $('#seleremmz' + dd).val();
                var designername = $('#selernnz' + dd).text();
                var rndomz = Math.floor(Math.random() * 90000) + 10000;
                var rndomz2 = "Project" + rndomz;
                document.getElementById("c11").value = designername;
                document.getElementById("c22").value = designeremail;
                document.getElementById("c33").value = rndomz2;
            ...
            function AssignProjectz() {

                var designeremail = $('#c22').val();
                var designername = $('#c11').val();
                var projectid = $('#c33').val();
                var projecttitle = $('#c44').val();
                var projectcost = $('#c66').val();
                var datezz = new Date($('#c555').val());
                var day = datezz.getDate();
                var month = datezz.getMonth() + 1;
                var year = datezz.getFullYear();
                const dateInput = document.getElementById('c555');
                if (projecttitle == "") {
                    swal("Error!", "Enter valid project title..!", "error");

                } else if (projectcost == "") {

                    swal("Error!", "Enter valid cost..!", "error");
                } else if (!dateInput.value) {
                    swal("Error!", "Select Valid Date..!", "error");
                } else {
                    var finaldatez = year + "/" + month + "/" + day;

                    swal({
                        title: "Are you sure?",
                        text: "You want to Assign new  project to " + designername + " ?",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })
                            .then(function(willDelete) {
                                if (willDelete) {
                                    ...
                                    $.post("phpfiles/assignnewprjoect.php",
                                            {
                                                ...
                                                finaldatez: finaldatez
                                            },
                                    function(data, status) {
                                        if (data == "ok") {


                                            swal("Done!New Project Assigned..!", {
                                                icon: "success",
                                            });

                                            window.location = "AddProjecttoDesigner1.php";
