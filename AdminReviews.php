                                                ...
                                                <table class="table align-middle" id="customerTable">
                                                    <thead class="table-light text-muted">
                                                        <tr>
                                                            ...
                                                            <th class="sort" data-sort="email">Posted by</th>                                                    
                                                            <th class="sort" data-sort="email">Posted Email</th>                                                    
                                                            <th class="sort" data-sort="email">Posted to</th>    
                                                            <th class="sort" data-sort="status">Date</th>
                                                            <th class="sort" data-sort="status">Time</th>
                                                    ...
                                                    <tbody class="list form-check-all">
                                                        ...
                                                        $sqlzy34 = "SELECT * FROM itemhasreview where  status='Active'";
                                                        ...
                                                        foreach ($query4 as $value4) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="id" style="display:none;"><a href="javascript:void(0);" class="fw-medium link-primary"><?php echo $value4['idreview']; ?></a></td>
                                                                
                                                        
                                                        <td class="customer_name" id="selernnz<?php echo $value4['idreview']; ?>"><?php echo $value4['commentz']; ?></td>
                                                        <td class="email"><?php echo $value4['postedusername']; ?></td>
                                                        <td class="email"><?php echo $value4['posteduseremail']; ?></td>
                                                        <td class="email"><?php echo $value4['sellername']; ?></td>
                                                        <td class="email"><?php echo $value4['datez']; ?></td>
                                                        <td class="email"><?php echo $value4['timez']; ?></td>
                                                        <td>
                                                            <ul class="list-inline hstack gap-2 mb-0">
                                                                <li class="list-inline-item edit" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="ASsign Project">
                                                                    <button type="button" class="btn btn-danger add-btn" onclick="LoadModelz(<?php echo $value4['idreview']; ?>)">Remove</button>
                        ...
                        dangerMode: true,
                            ...
                            .then(function(willDelete) {
                                if (willDelete) {
                                    ...
                                    $.post("phpfiles/removereview.php",
                                            {
                                                dd: dd
                                            },
                                            function(data, status) {
                                                if (data == "ok") {
                                                    ...
                                                    window.location = "AdminReviews.php";
